...
HEADERS = [
    ...
    'A_OFF_RATING', 'A_DEF_RATING', 'A_AST_TOV', 'A_EFG_PCT', 'A_PACE', 'A_PIE',
    'H_OFF_RATING', 'H_DEF_RATING', 'H_AST_TOV', 'H_EFG_PCT', 'H_PACE', 'H_PIE',

    'A_PTS_OFF_TO', 'A_PTS_2ND_CHANCE', 'A_PTS_FB', 'A_PTS_PAINT', 'A_BLK',
    'H_PTS_OFF_TO', 'H_PTS_2ND_CHANCE', 'H_PTS_FB', 'H_PTS_PAINT', 'H_BLK',

    'A_DIST', 'A_ORBC', 'A_DRBC', 'A_TCHS', 'A_SAST', 'A_PASS', 'A_CFGM', 'A_CFGA',
    'A_UFGM', 'A_UFGA',
    'H_DIST', 'H_ORBC', 'H_DRBC', 'H_TCHS', 'H_SAST', 'H_PASS', 'H_CFGM', 'H_CFGA',
    'H_UFGM', 'H_UFGA'
]
...
def process_game(game_path):
    ...
    with open(os.path.join(game_path, 'tracking.json')) as f:
        ...
        for team in (0, 1):
            data += tracking['resultSets'][1]['rowSet'][team][6:9]
